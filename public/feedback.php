...
if( isset( $_POST["submitted"]))
{
	    ...
	    && empty($error_comments))
	{
		...
		header("Location: /phpcrudsample/public/modules/feedback/thankyou.php?firstname=$firstname & lastname=$lastname ");
...
<table width="800">
  <tr>
    <td>First Name</td>
    <td><input type="text" name="firstname" size="50" required title="Cannot be empty field"></td>
	<td><?=$error_firstname?></td>
  </tr>
  <tr>
    <td>Last Name</td>
    <td><input type="text" name="lastname" size="50" required title="Cannot be empty field"></td>
	<td><?=$error_lastname?></td>
  </tr>
  <tr>    
    <td>Email</td>
    <td><input type="text" name="email" size="50" pattern=".{1,}"   required title="Cannot be empty field" ></td>
  </tr>
  <tr>    
    <td>Comments</td>
